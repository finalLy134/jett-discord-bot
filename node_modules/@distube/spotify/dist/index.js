...
var SpotifyPlugin = class extends import_distube.CustomPlugin {
  constructor(options = {}) {
    ...
    if (typeof this.parallel !== "boolean") {
      throw new import_distube.DisTubeError("INVALID_TYPE", "boolean", this.parallel, "parallel");
    }
    this.emitEventsAfterFetching = options.emitEventsAfterFetching ?? false;
    if (typeof this.emitEventsAfterFetching !== "boolean") {
      throw new import_distube.DisTubeError("INVALID_TYPE", "boolean", this.emitEventsAfterFetching, "emitEventsAfterFetching");
    }
    API.setAccessToken("");
    if (options.api !== void 0 && (typeof options.api !== "object" || Array.isArray(options.api))) {
      ...
      if (typeof options.api.clientId !== "string") {
        throw new import_distube.DisTubeError("INVALID_TYPE", "string", options.api.clientId, "api.clientId");
      }
      if (typeof options.api.clientSecret !== "string") {
        throw new import_distube.DisTubeError("INVALID_TYPE", "string", options.api.clientSecret, "api.clientSecret");
      }
